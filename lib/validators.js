    ...
    return this.add( function ( val ){
      try{
        ValidatorPrototype[ name ].
          apply( externalValidator.check( val, err ), args );
      }catch( e ){
        return { error : err };
      }
...
validators.contains = function ( test, msg ){
  ...
  return this.add( function ( val ){
    try{
      ValidatorPrototype.contains.call( externalValidator.check( val, err ), test );
    }catch( e ){
      return { error : err };
    }
...
validators.notContains = function ( test, msg ){
  ...
  return this.add( function ( val ){
    try{
      ValidatorPrototype.notContains.call( externalValidator.check( val, err ), test );
    }catch( e ){
      return { error : err };
    }
...
validators.equals = function ( other, msg ){
  ...
  return this.add( function ( val, src ){
    ...
    return val == test ?
      ...
      { error : {
          field : self.name,
          msg   : ( msg || self.msg.equals ).replace( /%t/, String( test ))
        }
      };
  });
};
  ...
  return this.add( function ( val ){
    try{
      ValidatorPrototype.len.
        call( externalValidator.check( val, err ), min, max );
    }catch( e ){
      return { error : err };
    }
