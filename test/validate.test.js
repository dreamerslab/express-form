...
module.exports = {
  ...
  'validate : isUrl': function() {
    ...
    assert.equal(request.form.errors.length, 1);
    assert.equal(request.form.errors[0], "field is not an URL");
  ...
  'validate : equals': function() {
    ...
    assert.equal(request.form.errors.length, 1);
    assert.equal(request.form.errors[0], "field does not equal to other");
    ...
    assert.equal(request.form.errors.length, 1);
    assert.equal(request.form.errors[0], "field1 does not equal to value2");
    ...
    assert.equal(request.form.errors.length, 1);
    assert.equal(request.form.errors[0], "field1.deep does not equal to value2");
